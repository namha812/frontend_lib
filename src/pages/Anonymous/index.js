...
class Home extends Component {
  ...
  render() {
    ...
    return (
      <React.Fragment>
        <Appbar  redirect={this.props.redirect} loginStatus={loginStatus} openDrawer={this.onOpenDrawer} />
        <Drawer loginStatus={false} openDrawer={openDrawer} onClose={this.onCloseDrawer} onChangeRoute={this.onChangeRoute} />
        <Searchbox loginStatus={false} placeholder="Search" onChangeSearchValue={this.onChangeSearchValue} />
        <Dashboard
